      ...
      <div className="max-w-[1450px]">
        <div className="grid grid-cols-1 md:grid-cols-2 pt-5 md:pt-30">
          <div className=" space-y-6 flex flex-col justify-center items-center md:items-start">
            ...
            <div>
              <button className="text-gray-800 text-2xl underline font-bold bg-white hover:bg-blue-600 hover:text-amber-50 px-6 py-2 rounded-md cursor-pointer">
                Get Started
              </button>
            </div>
          </div>
        ...
        <div className="w-full grid grid-cols-2 md:grid-cols-4 bg-linear-to-r from-cyan-200 to-blue-50 md:rounded-3xl h-50 md:py-3">
