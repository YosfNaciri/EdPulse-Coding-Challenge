      ...
      <div className="max-w-[1450px]">
        <div className="grid grid-cols-1 md:grid-cols-2 pt-5 md:pt-30">
          ...
          transition={{ duration: 0.6, ease: "linear" }}
            className="text-4xl xl:text-7xl font-bold text-center md:text-start w-96 md:w-auto">
              Enhance Your{" "}
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.6, ease: "linear" }}
            className="text-gray-600 w-96 xl:text-xl text-center md:w-auto md:text-start">
        ...
        <div className="shadow-xl w-full grid grid-cols-2 md:grid-cols-4 bg-linear-to-r from-cyan-200 to-blue-50 md:rounded-3xl h-50 md:py-3">
          <div className="flex items-center justify-center flex-col gap-1 text-gray-800">
            <h1 className="text-4xl xl:text-7xl font-bold"><CountUp end={250} duration={1} />+</h1>
            <h3 className="md:text-2xl ">subjects</h3>
          </div>
          <div className="flex items-center justify-center flex-col gap-1 text-gray-800">
            <h1 className="text-4xl xl:text-7xl font-bold"><CountUp end={150} duration={1} />+</h1>
            <h3 className="md:text-2xl ">Professional tutors</h3>
          </div>
          <div className="flex items-center justify-center flex-col gap-1 text-gray-800">
            <h1 className="text-4xl xl:text-7xl font-bold"><CountUp end={500} duration={1} />+</h1>
            <h3 className="md:text-2xl "> Courses</h3>
          </div>
            <div className="flex items-center justify-center flex-col gap-1 text-gray-800"> 
            <h1 className="text-4xl xl:text-7xl font-bold"><CountUp end={9000} duration={1} />+</h1>
